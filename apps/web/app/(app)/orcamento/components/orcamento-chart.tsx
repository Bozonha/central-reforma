...
export interface OrcamentoChartRow {
  categoria: string;
  planejado: number;
  comprado: number;
  pago: number;
...
export function OrcamentoChart({ data }: { data: OrcamentoChartRow[] }) {
    ...
    <div className="h-72 w-full">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} margin={{ top: 8, right: 8, left: 8, bottom: 8 }} barGap={4}>
          ...
          <Bar dataKey="comprado" name="Comprado" fill="var(--chart-2)" radius={[4, 4, 0, 0]} />
